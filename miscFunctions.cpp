...
// A function to check if a file exists and if it does not exist it will create a
// The code defines functions for checking if a file exists, parsing a file name
// to ensure it has the correct extension, and converting image data from a 3D vector
// to a 1D array. It also includes necessary header files and uses a configuration
